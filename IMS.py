...
def ShowView():
    global viewform
    viewform = Toplevel()
    viewform.title("GARUDA INVENTORY MANAGEMENT/View Product")
    width = 600
    height = 400
    screen_width = Home.winfo_screenwidth()
    screen_height = Home.winfo_screenheight()
...
def ViewForm():
    ...
    btn_reset = Button(LeftViewForm, text="Refresh")
    btn_reset.pack(side=TOP, padx=10, pady=10, fill=X)
    btn_delete = Button(LeftViewForm, text="Delete", fg= 'black', bg='red')
